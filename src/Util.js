...
export function emotionProbDict(data){
    if (data==0){
        ...
        const responsePredictions = [{ emotion: 'Happy', probability: data.prediction[0] },
                                    { emotion: 'Sad', probability: data.prediction[1] },
                                    { emotion: 'Neutral', probability: data.prediction[2] },
                                    { emotion: 'Angry', probability: data.prediction[3] },
                                    { emotion: 'Excited', probability: data.prediction[4] },
                                    { emotion: 'Frustrated', probability: data.prediction[5] }];
